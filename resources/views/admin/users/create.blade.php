...
@section('content')
    <div class="container shadow card mt-4 p-lg-5">
        <h1 class="text-center text-decoration-underline mb-3 mt-2">Create User</h1>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Registration User</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="username" name="name" value="{{ old('name') }}" placeholder="Enter username"
                                    required>
                            </div>
                            <div class="mb-3">
                                ...
                                @error('photo')
                                    <span class="text-danger"> * {{ $message }} </span>
                                @enderror
                                <input class="form-control" type="file" value="{{ old('photo') }}" name="photo"
                                    id="formFile">
                            </div>
                            <!-- Email Field -->
                            <div class="mb-3">
