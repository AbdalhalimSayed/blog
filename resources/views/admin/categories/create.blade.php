...
@section('content')
    <div class="container shadow card mt-4 p-lg-5">
        ...
        <h1 class="text-center text-decoration-underline mb-3 mt-2">Create Category</h1>
        ...
        <form action="{{ route('admin.categories.store') }}" method="post">
            ...
            <div class="mt-3">
                ...
                <select name="type" id="catSection" class="form-control">
                    <option value="0" selected>Super Category</option>
            ...
            <div class="mt-3">
                <input class="btn btn-primary form-control" type="submit" value="Create Category">
            </div>
        </form>
    </div>
@endsection
